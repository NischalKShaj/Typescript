...
class ZooAnimals {
    ...
    displayInfo() {
        console.log(`This is a zoo name: ${this.name} and this zoo is ${this.age}years old`);
    }
}
...
class Mamals extends ZooAnimals {
    ...
    displayInfo() {
        console.log(`This is a mammal its name is ${this.name} and it is ${this.age} years old  and its fur color is ${this.color}`);
    }
}
...
class Birds extends ZooAnimals {
    ...
    displayInfo() {
        console.log(`This is a bird its name is ${this.name} and it is ${this.age} years old and its feathre color is ${this.featherColor}`);
    }
}
// class reptile which is also another extended class
class Reptile extends ZooAnimals {
    constructor(name, age, scaleType) {
        super(name, age);
        this.scaleType = scaleType;
    }
    displayInfo() {
        console.log(`This is a reptile its name is ${this.name} and it is ${this.age} years old and its skin type is${this.scaleType} `);
    }
}
